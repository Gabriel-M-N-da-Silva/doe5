<html>
    ...
    <head>
        ...
        <link rel="stylesheet" href="./assets/styles/ban_screen.css">
    </head>
    ...
    <section id="main">
        ...
        <form id='form-search' name='search' action='ban_screen.php' method='get'>
